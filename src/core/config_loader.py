...
class ConfigLoader:
    ...
    def get_settings(self) -> Dict[str, Any]:
        ...
        # Her çağrıda settings.json'ı yeniden yükle
        self.settings = self._load_json(self.settings_file, default_value={})
        return self.settings

    def get_accounts_config(self) -> List[Dict[str, Any]]:
        """Returns all loaded account configurations."""
        # Her çağrıda accounts.json'ı yeniden yükle
        self.accounts = self._load_json(self.accounts_file, default_value=[])
    ...
    def _replace_env_vars(self, content: str) -> str:
        """
        Replaces environment variable placeholders in JSON content.
        
        Args:
            content (str): JSON content with environment variable placeholders
            
        Returns:
            str: JSON content with environment variables replaced
        """
